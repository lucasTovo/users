/**
  ...
  * @license MIT
  */
import { isRef, computed, onMounted, watch, onBeforeUnmount, watchEffect, inject, ref, reactive, defineComponent, toRef, nextTick, h, provide } from 'vue';
...
function normalizeOptions(name, opts) {
    const form = inject(FormSymbol, undefined);
    const defaults = () => ({
...
function useValidationState({ name, initValue, form, type, valueProp, }) {
    ...
    const initialValue = (_a = getFromPath(unwrap(inject(FormInitialValues, {})), name)) !== null && _a !== void 0 ? _a : initValue;
...
const Field = defineComponent({
    ...
    setup(props, ctx) {
        ...
        return () => {
            ...
            if (tag) {
                return h(tag, Object.assign(Object.assign(Object.assign({}, ctx.attrs), slotProps.field), (isHTMLTag(tag) ? slotProps.aria : {})), children);
            }
            return children;
        };
    },
